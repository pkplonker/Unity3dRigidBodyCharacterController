...
public class PlayerCameraController : MonoBehaviour
{
	...
	[SerializeField] [Range(2, 300)] float lookSpeed = 0.1f;
	...
	[SerializeField] private float cameraCollisionCheckRadius = 0.4f;
	...
	private void HandleCameraCollisions()
	{
		...
		cameraTransformPosition.z = Mathf.Lerp(cameraTransform.localPosition.z, targetPosition,
			cameraCollisionSpeed * Time.deltaTime);
